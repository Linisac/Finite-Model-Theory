...
\newcommand{\of}[1]{{[#1]}} %logic (or ordered class} with vocabulary #1
...
\newcommand{\inflog}[1][]{\dlog[#1]{\infty}} %infinitary logic optionally parameterized by number of variables
