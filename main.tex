...
\newcommand{\ball}[2][]{\ifthenelse{\equal{#1}{}}{{\mathit{S}(#2)}}{{\mathit{S}^{#1}(#2)}}}
\newcommand{\ballstrct}[2][]{\ifthenelse{\equal{#1}{}}{{\mathcal{S}(#2)}}{{\mathcal{S}^{#1}(#2)}}}
%% >
...
\newcommand{\gaifman}[1]{{\mathcal{G}(#1)}} %the Gaifman graph of #1 (structure)
%% >
