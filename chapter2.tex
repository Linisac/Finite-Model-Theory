...
\medskip\\
The above argument suggests (the essential part of) a winning strategy of the game $\game{m}(\strct{A}, \vect{a}, \strct{B}, \vect{b})$ for the spoiler when (iii) in 2.2.8 is false, say, there is a formula $\varphi(x_1, \etc, x_s)$ of quantifier rank $> 0$ such that $\strct{A} \satis \varphi[\vect{a}]$ but not $\strct{B} \satis \varphi[\vect{b}]$: If $\varphi = \exists y \psi$, then $\strct{A} \satis \exists y \psi[\vect{a}]$ and he picks an element $a \in A$ such that $\strct{A} \satis \psi[\vect{a}a]$; if $\varphi = \forall y \psi$, then not $\strct{B} \satis \varphi[\vect{b}]$ (hence $\strct{B} \satis \exists y \neg\psi[\vect{b}]$) and he picks an element $b \in B$ such that $\strct{B} \satis \neg\psi[\vect{b}b]$. That is to say, the spoiler always chooses an element of either $\strct{A}$ or $\strct{B}$ that corresponds to the existential quantifier.\footnote{Therefore, in case that there is a formula $\varphi(x_1, \etc, x_s)$ of quantifier rank $> 0$ such that $\strct{A} \satis \varphi[\vect{a}]$ but not $\strct{B} \satis \varphi[\vect{b}]$, it is justified to call the spoiler's moves in $\strct{A}$ the $\exists$-moves and his moves in $\strct{B}$ the $\forall$-moves.} The spoiler then makes his successive choices accordingly in his turns in every play of the game.
%
\end{enumerate}
%end of section 3-----------------------------------------------------------------------------
