...
\end{conjecture}
%
\item \header{Hint to Exercise 3.3.15} (INCOMPLETE) It suffices to show $\winpos[s]{s}(\strct{A}, \strct{B}) \subseteq \winpos[s]{\infty}(\strct{A}, \strct{B})$ for relational $\tau$.
