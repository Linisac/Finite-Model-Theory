...
\end{center}
%
\item \header{Note on 3.3.11} The underlying vocabulary $\tau$ is relational, as in 3.2.11. Also, for $s \geq 1$, $\conjextaxm{s}$ is satisfiable because $\randstrtheory \consq \conjextaxm{s}$.
