...
\end{conjecture}
%
\item \header{Hint to Exercise 3.3.15} (INCOMPLETE) If $\tau = \empty$ then we refer to the discussion in 3.3.6(a). So let us assume $\tau \sete{R_1, \etc, R_n}$ for some $n \geq 1$.
%
