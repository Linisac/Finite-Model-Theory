...
%
\item \header{Note on \thesection.6(a)} (INCOMPLETE) For arbitrary $\emptyvoc$-structures $\strct{A}$ and $\strct{B}$, the duplicator wins $\game[s]{\infty}(\strct{A}, \strct{B})$ iff he wins $\game[s]{s}(\strct{A}, \strct{B})$.
%
