...
\begin{enumerate}[1.]
%
\item \header{Subformulas of $\Logic{\infty\omega}$-Sentences Only Have Finitely Many Free Variables.} If $\varphi \in \Logic{\infty\omega}$ has infinitely many free variables, then one can show by induction on formation that any $\Logic{\infty\omega}$-formula having $\varphi$ as a subformula must also have infinitely many free variables.
%
